...
app.post('/articles', function(request, response) {
  ...
  function queryThree(author_id) {
    client.query(
      `INSERT INTO articles(author_id, title, category, "publishedOn", body) VALUES($1, $2, $3, $4, $5) ON CONFLICT DO NOTHING`, // done: Write a SQL query to insert the new article using the author_id from our previous query
